...
Computer Science Engineering student at **SNS College of Technology, Coimbatore** (CGPA: 7.8) with hands-on industry experience across four internships spanning AI, Cloud, Full Stack, and Data Engineering domains. I build end-to-end systems — from training machine learning models to deploying cloud-native applications — with a consistent focus on solving real problems through scalable, production-ready software.

My work spans **IBM Watson AI Studio**, **AWS cloud infrastructure**, **MERN Stack development**, and **computer vision with YOLOv8**. I have collaborated in Agile teams of 20+ members, delivered dashboards for business intelligence, and shipped full-stack AI platforms to production environments.

Currently seeking roles in **Software Engineering**, **AI/ML Engineering**, **Cloud Solutions**, or **Full Stack Development** at product-based companies.
...
![IBM Cloud](https://img.shields.io/badge/IBM%20Cloud-1F70C1?style=for-the-badge&logo=ibm&logoColor=white)
...
### Texperia — Event Management Platform

A production-grade full-stack event management system built for college-scale operations.
...
### ThunaivanAI — Government Scheme Explainer

A full-stack AI platform that makes government welfare schemes accessible to citizens through conversational AI.
...
### AuraSafe — Women Safety Application

A real-time women safety web application with AI-driven distress detection and emergency alert infrastructure.
...
### Home Security Automation — Computer Vision System

An intelligent home security system combining real-time object detection with identity recognition and cloud alerting.
